...
function wpi_enqueue_scripts() {
	...
	// sliick slider
    wp_register_script( 'slick-min-js', get_stylesheet_directory_uri().'/lib/slick-slider/slick.min.js', [ 'jquery', 'acf' ], '1.1.0', true );
    wp_register_script( 'slick-init-js', get_stylesheet_directory_uri().'/acf-blocks/testimonials/script.js', [ 'jquery', 'acf' ], '1.1.0', true );

    wp_register_style( 'slick-css', get_stylesheet_directory_uri().'/lib/slick-slider/slick.css' );
    wp_register_style( 'slick-theme-css', get_stylesheet_directory_uri().'/lib/slick-slider/slick-theme.css' );
